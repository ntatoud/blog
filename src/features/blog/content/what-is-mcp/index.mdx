...
translations:
  - lang: 'fr'
    url: https://bearstudio.fr/blog/developpement/decouvrir-le-mcp-une-nouvelle-approche-pour-vos-agents-ia
tags:
  - AI agents
  - MCP
  - TypeScript
...
import MCPSchema from './mcp-schema.astro';
...
_We won't go into detail about how AI agents work, but you can read this intro article from Google: <a href="https://cloud.google.com/discover/what-are-ai-agents?hl=fr" className="underline not-italic hover:no-underline hover:opacity-80">Google Cloud - What are AI agents?</a>_
